 ...
 * @lucene.experimental
 */
public final class Lucene99VamanaVectorsFormat extends KnnVectorsFormat {

  static final String META_CODEC_NAME = "Lucene99VamanaVectorsFormatMeta";
  static final String VECTOR_INDEX_CODEC_NAME = "Lucene99VamanaVectorsFormatIndex";
   ...
   * {@link Lucene99VamanaVectorsFormat#DEFAULT_MAX_CONN}. See {@link HnswGraph} for more details.
   */
  private final int maxConn;

  /**
   * The number of candidate neighbors to track while searching the graph for each newly inserted
   * node. Defaults to {@link Lucene99VamanaVectorsFormat#DEFAULT_BEAM_WIDTH}. See {@link HnswGraph}
   * for details.
   */
  ...
  public Lucene99VamanaVectorsFormat() {
   ...
   */
  public Lucene99VamanaVectorsFormat(int maxConn, int beamWidth) {
  ...
  public Lucene99VamanaVectorsFormat(
    ...
    super("Lucene99VamanaVectorsFormat");
  ...
  public KnnVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new Lucene99VamanaVectorsWriter(
        state,
        maxConn,
        beamWidth,
  ...
  public KnnVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new Lucene99VamanaVectorsReader(state, flatVectorsFormat.fieldsReader(state));
  }
  ...
  public String toString() {
    return "Lucene99VamanaVectorsFormat(name=Lucene99VamanaVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", flatVectorFormat="
