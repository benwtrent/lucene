 ...
 * @lucene.experimental
 */
public final class Lucene101HnswVectorsReader extends KnnVectorsReader
    implements QuantizedVectorsReader, HnswGraphProvider {

  private static final long SHALLOW_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(Lucene101HnswVectorsFormat.class);
  ...
  public Lucene101HnswVectorsReader(SegmentReadState state, FlatVectorsReader flatVectorsReader)
      throws IOException {
      ...
      try {
        versionMeta =
            CodecUtil.checkIndexHeader(
                ...
                Lucene101HnswVectorsFormat.VERSION_START,
  ...
  private Lucene101HnswVectorsReader(
      Lucene101HnswVectorsReader reader, FlatVectorsReader flatVectorsReader) {
    this.flatVectorsReader = flatVectorsReader;
  ...
  public KnnVectorsReader getMergeInstance() {
    return new Lucene101HnswVectorsReader(this, this.flatVectorsReader.getMergeInstance());
  }
  ...
  public long ramBytesUsed() {
    return Lucene101HnswVectorsReader.SHALLOW_SIZE
        + fields.ramBytesUsed()
  ...
  private static final class OffHeapHnswGraph extends HnswGraph {
    ...
    OffHeapHnswGraph(FieldEntry entry, IndexInput vectorIndex) throws IOException {
      ...
      this.byteSizeByLevel = entry.byteSizeByLevel;
