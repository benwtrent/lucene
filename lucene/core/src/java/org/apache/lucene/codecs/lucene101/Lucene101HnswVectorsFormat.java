 ...
 * @lucene.experimental
 */
public final class Lucene101HnswVectorsFormat extends KnnVectorsFormat {

  static final String META_CODEC_NAME = "Lucene101HnswVectorsFormatMeta";
  static final String VECTOR_INDEX_CODEC_NAME = "Lucene101HnswVectorsFormatIndex";
   ...
   * {@link Lucene101HnswVectorsFormat#DEFAULT_MAX_CONN}. See {@link HnswGraph} for more details.
   */
  private final int maxConn;

  /**
   * The number of candidate neighbors to track while searching the graph for each newly inserted
   * node. Defaults to {@link Lucene101HnswVectorsFormat#DEFAULT_BEAM_WIDTH}. See {@link HnswGraph}
   * for details.
   */
  ...
  public Lucene101HnswVectorsFormat() {
   ...
   */
  public Lucene101HnswVectorsFormat(int maxConn, int beamWidth) {
  ...
  public Lucene101HnswVectorsFormat(
    ...
    super("Lucene101HnswVectorsFormat");
  ...
  public KnnVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new Lucene101HnswVectorsWriter(
        state,
        maxConn,
        beamWidth,
  ...
  public KnnVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new Lucene101HnswVectorsReader(state, flatVectorsFormat.fieldsReader(state));
  }
  ...
  public String toString() {
    return "Lucene101HnswVectorsFormat(name=Lucene101HnswVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", flatVectorFormat="
